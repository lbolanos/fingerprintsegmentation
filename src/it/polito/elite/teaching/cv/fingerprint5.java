...
public class fingerprint5 {
	...
	public static void main(String[] args) throws IOException {
		...
		if( !DEBUG )	{
			...
			//maskFingerP(new File(ORI_FOLDER + "fp_59.jpg"), 1);
			//maskFingerP(new File(ORI_FOLDER + "fp_64.jpg"), 1);
			//maskFingerP(new File(ORI_FOLDER + "_before1532735116480.png.jpg"), 1);
			//maskFingerP(new File(ORI_FOLDER_ND + "fp_33.jpg"), 1);
			//maskFingerP(new File(ORI_FOLDER_ND + "fp_00.jpg"), 1);
			//maskFingerP(new File(ORI_FOLDER_ND + "fp_08.jpg"), 1);
			//maskFingerP(new File(ORI_FOLDER_ND + "fp_79.jpg"), 3);
			//maskFingerP(new File(ORI_FOLDER_ND + "fp_01.jpg"), 3);
			maskFingerP(new File(ORI_FOLDER_ND + "fp_12.jpg"), 4);
		}
		
	}

	private static void maskFingerP(File input, int mode ) throws IOException {
		if( mode > 4 ) {
			return;
		}
        ...
        if( mode == 4 ) {
        	int border = 8;
        	Rect rectCrop = new Rect(border, border, mat.cols() - (border*2), mat.rows() - (border*2));
			...
			mat = dst.clone();
			if( DEBUG )	writeMat2(DEST_FOLDER + "copyMakeBorder3",mat);			
        }

        Mat mat2 = doCanny(mat, mode );
